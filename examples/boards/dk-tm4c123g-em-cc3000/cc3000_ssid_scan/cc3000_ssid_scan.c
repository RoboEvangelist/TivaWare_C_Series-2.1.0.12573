...
//! DK-TM4C123G Development Kit.  After booting and initializing the CC3000,
//! the application initiates a WiFi scan for access points.  When the scan
...
initDriver(void)
{
    ...
    //
    // Remember our system clock rate.
    //
    ...
    //
    // Enable GPIOA to allow us to configure the UART0 pins.
    //
...
ScreenInit(void)
{
    ...
    GrStringDrawCentered(&g_sContext, "cc3000 ssid scan", -1,
