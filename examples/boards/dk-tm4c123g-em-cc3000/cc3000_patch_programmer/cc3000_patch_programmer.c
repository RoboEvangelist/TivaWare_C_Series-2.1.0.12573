...
//*****************************************************************************
char *
sendDriverPatch(unsigned long *pulLength)
{
    //
...
//*****************************************************************************
char *
sendBootLoaderPatch(unsigned long *pulLength)
{
    //
    // Parameter sanity check.
    //
...
//*****************************************************************************
char *
sendWLFWPatch(unsigned long *pulLength)
{
    //
    // Parameter sanity check.
    //
...
initCC3000(unsigned short cRequestPatch)
{
    ...
    //
    // Indicate that we are active and initiate WiFi successfully.
    //
    UARTprintf("Done.\n");
...
ScreenInit(void)
{
    ...
    GrStringDrawCentered(&g_sContext, "CC3000 Patcher", -1,
...
main(void)
{
    ...
    //
    // Initialize CC3000 to check for patches from host
    //
    ...
    //
    UARTprintf("Getting existing MAC address from EEPROM... ");
    ...
    UARTprintf("Done.\nReading existing RM parameters from EEPROM... ");
    ...
    if (counter == 3)
    {
        UARTprintf("Using default RM parameters.\n");
    ...
    UARTprintf("Writing new FAT to EEPROM... ");
    ...
    UARTprintf("Done.\nWriting RM parameters to EEPROM... ");
    ...
    {
        UARTprintf("No EEPROM address to write.\n");
    }

    ucStatus_Dr = 1;

    UARTprintf("Writing driver patch to EEPROM... ");
    ...
    UARTprintf("Done.\nWriting firmware patch to EEPROM... ");
    ...
    //
    // Indicate that the patch programmer finished.
    //
    UARTprintf("Patch programming completed successfully.\n");
