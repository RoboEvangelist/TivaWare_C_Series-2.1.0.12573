...
uint32_t CloudTaskInit(void)
{
    ...
    //
    g_xCloudTimerHandle = xTimerCreate((signed char *)"Cloud Timer",
    ...
    //
    g_xSwitchesTimerHandle = xTimerCreate((signed char *) "Switch Timer",
    ...
    //
    if(xTaskCreate(CloudTask, (signed portCHAR *)"Cloud",
